    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/2026/01/10/slide-cleaning.html";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%76%61%69%62%68%61%76@%72%72%69.%72%65%73.%69%6E", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-0895-6106", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/@vaibhavparmar42", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=FHJ0Kg0AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
